...
""" % bcb_dev)
  ...
  if OPTIONS.backuptool:
    ...
    script.Mount("/system")
    script.RunBackup("backup", "/system_root/system" if is_system_as_root else "/system")
  ...
  if OPTIONS.backuptool:
    ...
    script.Mount("/system")
    script.RunBackup("restore", "/system_root/system" if is_system_as_root else "/system")
    script.Unmount("/system")
    if is_system_as_root:
      script.fstab["/system"].mount_point = "/"
